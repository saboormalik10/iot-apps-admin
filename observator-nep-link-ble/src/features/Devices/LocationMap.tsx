  ...
  if (!locationEnabled) {
    return <View style={styles.container}>
      <View style={[styles.content, { height: mapHeight }]}>
        <Text style={styles.text}>Can't get permission for location updates. Please check your settings in the device's location permission settings and NEP-LINK settings.</Text>
      </View>
    </View>
  }
