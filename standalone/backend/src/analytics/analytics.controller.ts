...
/**
 * `?deviceIds=a&deviceIds=b` and `?deviceIds=a,b` both mean two ids. The comma
 * form used to arrive as ONE value: it reached `new Types.ObjectId('a,b')` as a
 * 500, and slipped past the "at most 5 devices" limit.
 */
