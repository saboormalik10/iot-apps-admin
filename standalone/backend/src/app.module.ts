...
// Alerts: the sensor stream emits MET_MEASURES each minute, which
// AlertEvaluationService listens to.
...
@Module({
  imports: [
    ...
    RolesModule,
    SetupModule,
    // After SetupModule: on a fresh install first-run creates the station the
    // stream writes to.
    StreamModule,
    QueryModule,
  ],
