...
export interface IMetRecord extends Document {
  ...
  /** Local calendar day (YYYY-MM-DD) this record groups. */
  dayKey: string | null;
   ...
   * ~525,000 rows per station per year for no extra fidelity.
   */
...
// NO expiry — weather data is kept indefinitely; see the note in MetMeasure.ts.
