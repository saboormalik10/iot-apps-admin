...
> **Superseded on 21 September 2026 by [`../../PLAN.md`](../../PLAN.md).** Kept for its
> reasoning — the wind-direction, gust and rain analysis still holds. Several items it
> lists as "BUILD" (minute aggregation, the gust, vector averaging) have since been built
> in the cloud project and are now copied rather than written.
>
> Requirements: [`../../CLIENT_REQUIREMENTS.md`](../../CLIENT_REQUIREMENTS.md)
> (formerly `CLIENT_REPLY_LOCAL_SOFTWARE.md`).
