 ...
 *
 * COLOUR-SOURCE RULE (§10.9): classes map **by index** onto our own validated palette
 * tokens (a CSS `--role`), never onto a colour sent by the backend. The 5 tendency /
 * 3 fog / 8 comfort states map onto reserved status tokens.
 */
