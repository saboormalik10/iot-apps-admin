...
export function LoginForm({ selfSignup = false }: { selfSignup?: boolean }) {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      } else if (err instanceof ApiError && err.code === 'ACCOUNT_PENDING') {
        setFormError(t('accountPending'));
      } else if (err instanceof ApiError && err.code === 'ACCOUNT_SUSPENDED') {
        // Told only after the password was right (the API checks it first).
