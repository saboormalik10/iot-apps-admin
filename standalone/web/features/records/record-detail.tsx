...
/**
 * Record detail (plan §Month 9) — the MET record view: a column-picker chart over
 * the full measure set, a paginated measures table, a raw-sentence inspector and
 * CSV export.
 */
        ...
        <div>
          ...
          {record.dayKey ? (
            <p className="mt-1 text-xs text-muted-foreground">
              ...
              {record.source === 'stream' ? ' · sensor stream' : ''}
            </p>
          ) : null}
