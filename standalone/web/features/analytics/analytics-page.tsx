...
export function AnalyticsPage() {
  ...
  if (!met.deviceId || !met.device) {
    return (
      <EmptyState
        title="No weather station"
        body="These charts need the weather station's readings. If this is empty, the station has not recorded anything yet — check the System page."
      />
    );
  }
