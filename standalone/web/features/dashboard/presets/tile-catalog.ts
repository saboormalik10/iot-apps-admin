...
export const MET_STATION_WIDGETS: StationWidget[] = [
  ...
  // Keys kept from the cloud so saved views still load; the figures behind them
  // are now rain today (from the station's rain-day start), and the rate.
  { key: 'precip_total', label: 'Rain today', unit: 'mm', type: 'stat' },
  { key: 'rain_hour', label: 'Rain last hour', unit: 'mm', type: 'stat' },
  { key: 'precip_rate', label: 'Rain rate', unit: 'mm/h', type: 'stat' },
];
