  ...
  return (
    <div className={`space-y-2 ${ROSE_BLOCK}`}>
      <div className="flex flex-wrap items-center gap-1">
        ...
        {/* Pinned right where there is room, on its own line where there is not:
            `ml-auto` alone pushed it past the card on a 375px screen, which is
            what made the whole dashboard scroll sideways (QA, 25 Sep 2026). */}
