...
/**
 * Alert-rule builder options. The sensor list mirrors the backend evaluator's
 * MET_SENSOR_MAP (alert-rules/evaluate.ts) EXACTLY — these are the only keys
...
export function sensorOptionsFor(_appType: AlertAppType): SensorOption[] {
  return MET_SENSOR_OPTIONS;
}
