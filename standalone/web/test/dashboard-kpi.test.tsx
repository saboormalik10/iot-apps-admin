...
describe('KpiRow (§10.8 summary enrichment)', () => {
  it('renders the KPI numbers and the sparklines', async () => {
    ...
    await waitFor(() => expect(screen.getByText('Stations')).toBeInTheDocument());
    ...
    // "Stations", not the cloud product's "Devices": the nav, the Stations
    // screen and the site guides all say station (25 Sep 2026).
