...
// The search box says "stations", not "devices, sessions and records": this
// product has one station and no sessions screen, and the palette was the last
// place still using the cloud's wording (QA, 24 Sep 2026).
describe('CommandPalette (plan §13)', () => {
  ...
  it('lists destinations and routes to the chosen one', async () => {
    const u = userEvent.setup();
    renderPalette();
    await u.click(screen.getByRole('button', { name: /search stations and records/i }));
