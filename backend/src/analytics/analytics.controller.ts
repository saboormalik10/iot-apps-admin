...
function includeDemo(v: string | undefined): boolean {
  return v === 'true';
}
...
export class AnalyticsController {
  ...
  @ApiQuery({ name: 'includeDemoMode', required: false })
  @Get('met/wind-rose')
  metWindRose(
    ...
    return this.analytics.metWindRose(user.organizationId, deviceId, from, to, period ?? 'instant', unit ?? 'm/s', {
      includeDemoMode: includeDemo(demo),
    });
  }
  ...
  metStatistics(
    ...
    return this.analytics.metStatistics(user.organizationId, deviceId, sensor, from, to, { includeDemoMode: includeDemo(demo) });
  }
  ...
  metWindGust(
    ...
    return this.analytics.metWindGust(user.organizationId, deviceId, from, to, interval ?? '1h', { includeDemoMode: includeDemo(demo) });
  }
  ...
  metComfort(
    ...
    return this.analytics.metComfort(user.organizationId, deviceId, from, to, interval ?? '1h', { includeDemoMode: includeDemo(demo) });
  }
  ...
  metFogRisk(
    ...
    return this.analytics.metFogRisk(user.organizationId, deviceId, from, to, interval ?? '1h', { includeDemoMode: includeDemo(demo) });
  }
  ...
  metPressureTendency(
    ...
    return this.analytics.metPressureTendency(user.organizationId, deviceId, hours ? parseInt(hours, 10) : 3, { includeDemoMode: includeDemo(demo) });
  }
  ...
  nepTurbidityDistribution(
    ...
    return this.analytics.nepTurbidityDistribution(user.organizationId, sessionId, deviceId, from, to, { includeDemoMode: includeDemo(demo) });
  }
  ...
  nepProbeBreakdown(
    ...
    return this.analytics.nepProbeBreakdown(user.organizationId, deviceId, from, to, { includeDemoMode: includeDemo(demo) });
  }
  ...
  nepCorrelation(
    ...
    return this.analytics.nepCorrelation(user.organizationId, sessionId, deviceId, from, to, { includeDemoMode: includeDemo(demo) });
  }
  ...
  nepGpsDensity(
    ...
    return this.analytics.nepGpsDensity(user.organizationId, deviceId, from, to, resolution ?? 'medium', { includeDemoMode: includeDemo(demo) });
  }
  ...
  @ApiQuery({ name: 'fromUnit', required: true })
  @ApiQuery({ name: 'toUnit', required: true })
  @Get('unit-convert')
